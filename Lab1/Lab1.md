...
The first step is to download the dataset that we will use. You can download it [here](https://github.com/michlin0825/Canvas_Tutorial_20220514/Data/bank-marketing.csv).
